...
const CLIENT_TESTIMONIALS = [
  {
    ...
    quote: "I recently worked with ZEN ARCH INTERIOR SOLUTION for a full interior manufacturing project, and the experience was excellent from start to finish. The craftsmanship was top-notch and materials used were of high quality.",
  },
  {
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          >
            <Image
              ...
              alt="Zen Arc Architectural Interior"
              fill
              priority
          ...
          <div className="w-full lg:w-1/2 space-y-10 pointer-events-auto">
            ...
            <Reveal delay={1.0}>
              <p className="text-zen-sand/90 text-sm md:text-lg font-light max-w-md leading-relaxed tracking-wide">
                Founded by <strong>{BRAND.founder}</strong> in Mumbai, Zen Arc harmonizes pure architectural spatial discipline with artisanal, custom-fabricated furniture.
              </p>
            </Reveal>
          </div>
        </div>
          ...
          <Reveal delay={0.5}>
            <div className="pt-4">
              ...
              <span className="text-[11px] uppercase tracking-[0.2em] text-zen-muted">
                Founder &amp; Creative Director, Zen Arc
              </span>
            </div>
          </Reveal>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <Parallax offset={40}>
            <ImageReveal 
              ...
              alt="Zen Arc Built Architecture" 
            ...
            <Reveal direction="left">
              <div className="space-y-4">
                ...
                <p className="text-xs md:text-sm text-zen-taupe font-light max-w-xl">
                  Sofas, lounges, ottomans, and sculptural benches verified across the 2026 Zen Arc catalogues.
                </p>
              </div>
            </Reveal>
            ...
            {filteredProducts.map((product, idx) => (
              <Reveal key={product.slug} delay={idx * 0.1} direction="up" distance={20}>
                <div className="bg-zen-ivory border border-zen-border p-6 hover:border-zen-black transition-all duration-300 group h-full flex flex-col">
                  <div className="aspect-square bg-zen-stone/40 border border-zen-border/60 flex items-center justify-center mb-6 overflow-hidden relative">
          ...
          <div className="lg:col-span-6 space-y-8">
            <Reveal direction="left">
              ...
              <p className="text-base font-light text-zen-taupe leading-relaxed mt-6">
                Upload a photograph of your living room. Our spatial intelligence model calculates floor proportions and pairs your room with verified Zen Arc pieces and real pricing.
              </p>
